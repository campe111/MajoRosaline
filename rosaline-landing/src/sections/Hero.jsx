...
export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-beige py-24 sm:py-32">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgba(107,142,35,0.15),_transparent_60%)]" />
      <div className="mx-auto flex w-full max-w-6xl flex-col-reverse items-center gap-12 px-6 sm:flex-row sm:gap-16">
        ...
        >
          <p className="mb-4 text-sm uppercase tracking-[0.35em] text-olive/80">Rosaline Olavarría</p>
          <h1 className="text-4xl leading-tight sm:text-5xl">
            Belleza capilar consciente con resultados profesionales
          </h1>
          <p className="mt-6 text-lg text-softBlack/80 sm:text-xl">
        ...
        <motion.div
          className="relative flex h-80 w-80 items-center justify-center rounded-full bg-blush/60 shadow-2xl shadow-blush/50 sm:h-[28rem] sm:w-[28rem]"
        ...
        >
          ...
          >
            <h2 className="text-3xl font-light uppercase tracking-[0.5em] text-softBlack/70">Hair Care</h2>
            <p className="mt-6 text-sm uppercase tracking-[0.44em] text-softBlack/50">Natural &amp; Vegano</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
