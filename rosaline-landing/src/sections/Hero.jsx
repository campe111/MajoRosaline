  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center gap-8 sm:grid-cols-2 sm:gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          <Motion.div
          ...
          >
            {/* Imagen de Rosaline en mobile, debajo del header */}
          ...
          {/* Imagen de Rosaline en desktop */}
          <Motion.div
            className="relative mx-auto hidden sm:flex h-64 w-64 items-center justify-center overflow-hidden rounded-[32px] border border-white/70 bg-gradient-to-br from-white via-cream to-rose/20 shadow-[0_45px_70px_-45px_rgba(47,47,47,0.45)] md:h-[26rem] md:w-[26rem] lg:h-[28rem] lg:w-[28rem]"
