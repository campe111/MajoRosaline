        ...
        <div className={`border-b border-rose/20 bg-white/85 backdrop-blur transition-shadow duration-300 ${
          ...
          <div className="relative mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-2.5 sm:px-6 sm:py-4 lg:py-5">
            <a
              ...
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center gap-2 text-sm font-changa uppercase tracking-[0.25em] text-rose transition hover:text-rose/90 whitespace-nowrap sm:relative sm:left-0 sm:top-0 sm:translate-x-0 sm:translate-y-0 sm:justify-start sm:gap-3 sm:text-base sm:tracking-[0.3em] lg:text-lg lg:tracking-[0.4em]"
            >
              {/* <img
                src={logo}
